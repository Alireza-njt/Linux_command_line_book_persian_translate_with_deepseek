...
<strong>بخش اول: "آموزش پوسته" </strong>
...
<strong>بخش دوم: "پیکربندی و محیط"</strong>
ویرایش فایل‌های پیکربندی که کنترل عملکرد کامپیوتر از طریق خط فرمان را ممکن می‌سازند<br>

<strong>بخش سوم: "کارهای متداول و ابزارهای ضروری"</strong>
...
<strong>بخش چهارم: "نوشتن اسکریپت‌های پوسته"</strong>
